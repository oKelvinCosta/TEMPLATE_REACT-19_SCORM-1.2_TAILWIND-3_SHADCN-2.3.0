...
// Loading State Management
    ...
    if (isInitializing) {
      return <div className="w-full flex justify-center items-center p-6">Carregando SCORM...</div>;
    }
  
    if (!isScormInitialized) {
      return <div className="w-full flex justify-center items-center p-6">Falha ao conectar com o SCORM</div>;
    }
